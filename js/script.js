...
module.exports = {
  ...
  /**
   * [merge2IntersectionString description]
   * 
   * @param  {[type]} str1 [description]
   * @param  {[type]} str2 [description]
   * @return {[type]}      [description]
   */
  merge2IntersectionString: function(str1, str2) {
    var result = '';
  ...
  getIntersection: function(str1, str2) {
    var nStr1 = str1.length,
      nStr2 = str2.length,
      grid = this.createGrid(str1.length, str2.length),
      longest = 0,
      matches = '',
      i,
      j;
  ...
  puzzle1: function(arg1, arg2) {
    ...
    if (nArg1 === 1) {
      ...
      var item1 = arg1[0],
        ...
        intersect = this.getIntersection(item1, item2);
        ...
        if (nItem1Occurred === 1 && nItem2Occurred === 1) {
          if (intersect) {
            ...
            */
            ...
            result = arg2.replace(intersect, this.puzzle1Replace(intersect));
            console.log(result);
